...
class Navigation extends Component {
    ...
    componentDidMount() {
        ...
        navButtons.addEventListener('click', (e) => {
            let view = e.target.closest('button').className;
            ...
            switch(view) {
                case 'nav--players':
                    viewContainer.classList.add('view-1--active');
                    break;
                case 'nav--round':
                    viewContainer.classList.add('view-2--active');
                    break;
                case 'nav--agenda':
                    viewContainer.classList.add('view-3--active');
                    break;
                case 'nav--settings':
                    viewContainer.classList.add('view-4--active');
                    break;
                default:
                    break;
            }
	...
	render() {
		return ( 
            <nav id="nav">
                <ul>
                    <li>
                        <button class="nav--players"><div className="nav__label">
                    ...
                    <li>
                        <button class="nav--round"><div className="nav__label">
                    ...
                    <li>
                        <button class="nav--agenda"><div className="nav__label">
                    ...
                    <li>
                        <button class="nav--settings"><div className="nav__label">
